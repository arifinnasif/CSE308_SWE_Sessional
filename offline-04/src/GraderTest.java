...
public class GraderTest {
    ...
    public static class AdditionalTester {
...
//    }
        ...
        public static Iterable<Object[]> data() {
            return Arrays.asList(new Object[][] {
                    ...
                    */
                    ...
                    { "Too Large Mark Credit 3", null, GraderTestGenerator.getCreditThree(), GraderTestGenerator.getTooLargeDouble(), IllegalArgumentException.class, "given marks is greater than fullmarks" },
                    { "Too Large Mark Credit 4", null, GraderTestGenerator.getCreditFour(), GraderTestGenerator.getTooLargeDouble(), IllegalArgumentException.class, "given marks is greater than fullmarks" },
                    { "Too Large Credit", null, GraderTestGenerator.getTooLargeDouble(), GraderTestGenerator.getValidMarks(), IllegalArgumentException.class, "invalid credit" },
            });
        }
    ...
    @RunWith(Parameterized.class)
    public static class ThreeCreditGradeTester {
        private Grader grader;
...
//    }
    ...
    @RunWith(Parameterized.class)
    public static class FourCreditGradeTester {
        private Grader grader;
